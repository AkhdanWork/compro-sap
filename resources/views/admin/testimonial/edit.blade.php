                ...
                <form action="{{ route('admin.testimonial.update', $testimonial->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        @if($testimonial->image)
                            <div class="mb-3">
                                ...
                                <img src="{{ asset('storage/'.$testimonial->image) }}" alt="{{ $testimonial->name }}" class="w-24 h-24 rounded-full object-cover border-2 border-gray-300">
                            </div>
                        @endif
                        ...
                        <div id="imagePreview" class="mt-3 hidden">
                            ...
                            <img src="" alt="Preview" class="w-24 h-24 rounded-full object-cover border-2 border-red-300">
                        </div>
                    </div>
                    ...
                    <div class="flex gap-3">
                        <button type="submit" class="px-6 py-2 bg-red-500 border border-red-500 text-white rounded-md hover:bg-transparent hover:text-red-500 transition">
                            <i class="bi bi-save mr-2"></i> Update Testimonial
                        </button>
