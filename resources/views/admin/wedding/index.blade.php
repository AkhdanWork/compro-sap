<!-- resources/views/admin/wedding/index.blade.php -->
<x-app-layout>
<div class="max-w-7xl mx-auto sm:px-6 lg:px-6 space-y-6 p-6">
        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
            <div class="container mx-auto p-4">
                <h1 class="text-2xl font-bold mb-4">Manage Wedding Organizer Content</h1>
                <a href="{{ route('admin.wedding.create') }}" class="bg-red-500 text-white px-4 py-2 rounded">Add New Content</a>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 mt-4">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-2 py-2 text-sm text-gray-500 grid grid-cols-2 gap-4 justify-items-left">
                                    <a href="{{ route('admin.wedding.edit', $content->id) }}" class="">
                        ...
                        <tbody>
                            <tr>
                                <td><p>{{ asset('storage/'.$content->image) }}</p></td>
                            </tr>
                        </tbody>
                        @endforeach
                    </table>
