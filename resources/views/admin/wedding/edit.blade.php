            ...
            <div class="container mx-auto p-4">
                <a href="{{ route('admin.wedding.index') }}" 
                   class="inline-flex items-center px-4 py-2 bg-red-500 border border-red-500 text-white rounded-md mb-4 hover:bg-transparent hover:text-red-500 transition">
                    <i class="bi bi-arrow-left mr-2"></i> Back to Wedding List
                </a>
                
                <h1 class="text-2xl font-bold mb-6">Edit Wedding Content</h1>
                ...
                <form action="{{ route('admin.wedding.update', $weddingContent->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" 
                                       name="title" 
                                       id="title" 
                                       value="{{ old('title', $weddingContent->title) }}"
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       name="client" 
                                       id="client" 
                                       value="{{ old('client', $weddingContent->client) }}"
                                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm" 
                            ...
                            <div>
                                ...
                                <input type="date" 
                                       name="date" 
                                       id="date" 
                                       value="{{ old('date', $weddingContent->date ? $weddingContent->date->format('Y-m-d') : '') }}"
                                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm" 
                                       required>
                            </div>
                            <div class="mt-6">
                                ...
                                <textarea name="description" 
                                        ...
                                        required>{{ old('description', $weddingContent->description) }}</textarea>
                            </div>
                        </div>
                                ...
                                @if($weddingContent->image)
                                    <div class="mb-4">
                                        ...
                                        <div class="relative inline-block">
                                            <img src="{{ asset('storage/'.$weddingContent->image) }}" 
                                                 alt="{{ $weddingContent->title }}" 
                    ...
                    <div class="flex gap-3 mt-8 pt-6 border-t border-gray-200">
                        <button type="submit" 
                            ...
                            <i class="bi bi-save mr-2"></i> Update Wedding Content
                        </button>
                        <a href="{{ route('admin.wedding.index') }}" 
