    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-6 space-y-6 p-6 mt-16">
        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
            <div class="container mx-auto p-4">
                ...
                <h1 class="text-2xl font-bold mb-6">Edit 3D Model Content</h1>
                ...
                <form action="{{ route('admin.dmodel.update', $dmodelContent->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" 
                                       name="title" 
                                       id="title" 
                                       value="{{ old('title', $dmodelContent->title) }}"
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       name="client" 
                                       id="client" 
                                       value="{{ old('client', $dmodelContent->client) }}"
                                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm" 
                            ...
                            <div>
                                ...
                                <input type="date" 
                                       name="date" 
                                       id="date" 
                                       value="{{ old('date', $dmodelContent->date ? $dmodelContent->date->format('Y-m-d') : '') }}"
                                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm" 
                                       required>
                            </div>
                            <div class="mt-6">
                                ...
                                <textarea name="description" 
                                        ...
                                        required>{{ old('description', $dmodelContent->description) }}</textarea>
                            </div>
                        </div>
                                ...
                                @if($dmodelContent->image)
                                    <div class="mb-4">
                                        ...
                                        <div class="relative inline-block">
                                            <img src="{{ asset('storage/'.$dmodelContent->image) }}" 
                                                 alt="{{ $dmodelContent->title }}" 
                    ...
                    <div class="flex gap-3 mt-8 pt-6 border-t border-gray-200">
                        <button type="submit" 
                            ...
                            <i class="bi bi-save mr-2"></i> Update 3D Model Content
                        </button>
                        <a href="{{ route('admin.dmodel.index') }}" 
