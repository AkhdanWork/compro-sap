    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-6 space-y-6 p-6 mt-16">
        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
            <div class="container mx-auto p-4">
                <a href="{{ route('admin.graphic.index') }}" 
                   class="inline-flex items-center px-4 py-2 bg-red-500 border border-red-500 text-white rounded-md mb-4 hover:bg-transparent hover:text-red-500 transition">
                    <i class="bi bi-arrow-left mr-2"></i> Back to Graphic List
                </a>
                
                <h1 class="text-2xl font-bold mb-6">Edit Graphic Content</h1>
                ...
                <form action="{{ route('admin.graphic.update', $graphicContent->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       name="client" 
                                       id="client" 
                                       value="{{ old('client', $graphicContent->client) }}"
                                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm" 
                            ...
                            <div>
                                ...
                                <input type="date" 
                                       name="date" 
                                       id="date" 
                                       value="{{ old('date', $graphicContent->date ? $graphicContent->date->format('Y-m-d') : '') }}"
                                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm" 
                                       required>
                            </div>
                            <div class="mt-6">
                                ...
                                <textarea name="description" 
                                        ...
                                        required>{{ old('description', $graphicContent->description) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                @if($graphicContent->image)
                                    <div class="mb-4">
                                        ...
                                        <div class="relative inline-block">
                                            <img src="{{ asset('storage/'.$graphicContent->image) }}" 
                                                 alt="{{ $graphicContent->title }}" 
                                                 class="w-full h-48 rounded-lg object-cover border-2 border-gray-300 shadow-sm">
                                ...
                                <p class="mt-1 text-sm text-gray-500">
                                    ...
                                    @endif
                                    Recommended: 1200px width, max 2MB.
                                </p>
                                
                                <div id="imagePreview" class="mt-4 hidden">
                                    <p class="text-sm text-gray-600 mb-2">New Image Preview:</p>
                                    <div class="relative inline-block">
                                        <img src="" alt="Preview" class="w-full h-48 rounded-lg object-cover border-2 border-red-300 shadow-sm">
                    ...
                    <div class="flex gap-3 mt-8 pt-6 border-t border-gray-200">
                        <button type="submit" 
                            ...
                            <i class="bi bi-save mr-2"></i> Update Graphic Content
                        </button>
                        <a href="{{ route('admin.graphic.index') }}" 
