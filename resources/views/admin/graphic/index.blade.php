<x-app-layout>
        ...
        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
            <div class="container mx-auto p-4">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-bold">Manage Graphic Content</h1>
                    <a href="{{ route('admin.graphic.create') }}" class="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600 transition inline-flex items-center">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-6">
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow border border-gray-200">
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex gap-2 mt-3 pt-3 border-t border-gray-200">
                                <a href="{{ route('admin.graphic.edit', $content->id) }}" 
                    ...
                    <div class="col-span-full text-center py-12">
                        ...
                        <p class="text-gray-500 text-lg">No Graphic content found.</p>
                        <a href="{{ route('admin.graphic.create') }}" 
                           class="inline-block mt-4 bg-red-500 text-white px-6 py-2 rounded hover:bg-red-600 transition">
                            Add Your First Graphic Content
                        </a>
                    </div>
                    @endforelse
                </div>
    ...
    <div id="deleteModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div class="mt-3 text-center">
                ...
                <h3 class="text-lg leading-6 font-medium text-gray-900">Delete Graphic Content</h3>
                <div class="mt-2 px-7 py-3">
                    <p class="text-sm text-gray-500">Are you sure you want to delete this Graphic content? This action cannot be undone.</p>
                </div>
    ...
    <script>
        function showModal(contentId) {
            document.getElementById('deleteForm').action = `/admin/graphic/${contentId}`;
