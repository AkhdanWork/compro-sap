    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-6 space-y-6 p-6 mt-16">
        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
            <div class="container mx-auto p-4">
                ...
                <h1 class="text-2xl font-bold mb-6">Add New Graphic Content</h1>
                ...
                <form action="{{ route('admin.graphic.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="flex gap-3 mt-8 pt-6 border-t border-gray-200">
                        <button type="submit" 
                            ...
                            <i class="bi bi-save mr-2"></i> Save Graphic Content
                        </button>
                        <a href="{{ route('admin.graphic.index') }}" 
