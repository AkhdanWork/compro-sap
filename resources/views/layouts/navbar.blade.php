<nav id="navbar" class="flex items-center justify-between
    ...
    <div class="flex items-center space-x-1 lg:space-x-4">
        <a href="#contact" class="inline-flex items-center px-1 lg:px-4 py-1 lg:py-1.5 bg-white text-red-600 font-semibold rounded-lg hover:bg-gray-100 transition shadow-lg group text-xs lg:text-base">
